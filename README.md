...
5. **macOS用户**：请参考 [macOS特定说明](#macos-使用说明)
...
1. **详细配置文档**：[浏览器环境配置指南](https://codercheng.notion.site/AdsPower-24722957056580138f05f35d4c58d2bf)
2. **视频教程**：[指纹浏览器配置视频](https://codercheng.notion.site/ads-23f2295705658017aa22d69fca2e0a90)
...
- **必须使用网盘中的指定插件版本；编辑器版本没有限制；记得禁止插件自动更新**
- **VSCode/Cursor**：必须使用网盘中的指定插件版本
- **JetBrains 系列**：必须使用网盘中的指定插件版本
